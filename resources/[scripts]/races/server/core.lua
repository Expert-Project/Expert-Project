...
-----------------------------------------------------------------------------------------------------------------------------------------
Expert = {}
Tunnel.bindInterface("races", Expert)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local Payments = {}
...
-- FINISH
-----------------------------------------------------------------------------------------------------------------------------------------
function Expert.Finish(Mode, Route, Points)
    local source = source
...
-- START
-----------------------------------------------------------------------------------------------------------------------------------------
function Expert.Start(Mode, Route)
    local source = source
    local Passport = vRP.Passport(source)
...
-- RANKING
-----------------------------------------------------------------------------------------------------------------------------------------
function Expert.Ranking(Mode, Route)
...
-- GLOBALSTATE
-----------------------------------------------------------------------------------------------------------------------------------------
function Expert.GlobalState(Mode, Route)
	local source = source
