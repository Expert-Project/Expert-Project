...
-----------------------------------------------------------------------------------------------------------------------------------------
Expert = {}
Tunnel.bindInterface("party",Expert)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local AmountRooms = 0
...
-- GETMEMBERS
-----------------------------------------------------------------------------------------------------------------------------------------
function Expert.GetMembers(Room)
	local source = source
...
-- CREATEROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function Expert.CreateRoom(Name,Password)
	local source = source
	local Passport = vRP.Passport(source)
...
-- KICKROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function Expert.KickRoom(Room,OtherPassport)
	local source = source
	local Room = parseInt(Room)
	local Passport = vRP.Passport(source)
...
-- ENTERROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function Expert.EnterRoom(Room,Password)
	local source = source
	local Room = parseInt(Room)
	local Passport = vRP.Passport(source)
